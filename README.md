...
# Customer Portal
This is an implementation for a customer portal, it features:
- JWT Token-based Authentication/Authorization
- Data persistance with PostgreSQL and Prisma ORM
- DB Hosting on PlanetScale and management with Vercel
- Use of new app directory in NextJS 13
- Protected Routes
- Tailwind
- API Route handlers
